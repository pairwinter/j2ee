...
OpenLayers.Handler.Paintbrush = OpenLayers.Class(OpenLayers.Handler.Point, {
    ...
    createFeature: function(pixel) {
        ...
        var style = OpenLayers.Util.applyDefaults({pointRadius: this.radius},OpenLayers.Feature.Vector.style['default']);
    ...
    _usePathAndCircle:function(lonlat){
        ...
        var radius = this.radius*this.layer.map.resolution;
...
//        this.layer.drawFeature(this.line, this.style);
        var style = OpenLayers.Util.applyDefaults({pointRadius: this.radius},OpenLayers.Feature.Vector.style['default']);
        this.layer.drawFeature(this.point, style);
