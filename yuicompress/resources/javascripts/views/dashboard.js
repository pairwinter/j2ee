(function(view) {
    ...
    view.dashboard.initDashboard = function(maxRows) {
        ...
        $(".extend-collapse").live("click", function() {
        	var me = $(this),
        		itemDiv = me.parent().parent(),
        		container = $(".dashboarditem-content", itemDiv),
        		title = me.attr('title'),
        		otherTitle = me.attr('data-other-title');
        	me.attr('title', otherTitle);
        	me.attr('data-other-title', title);
            if (container.is(":hidden")) {
                container.show();
                //itemDiv.css("height", itemDiv.attr("data-height") + "px");
                itemDiv.css("height", "100%");
                me.removeClass('icn_expand_16');
            } else {
                container.hide();
                itemDiv.css("height", "24px");
                me.addClass('icn_expand_16');
            }
        })
