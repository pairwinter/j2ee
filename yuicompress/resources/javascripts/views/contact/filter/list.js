...
(function(view){
    ...
    view.contact.filter.initPage=function(context){
        var filter_permission = EB_Common.Security.protect("RULE_add_edit_delete_view_list_contactLayer");
        $("#filter_gridTable").jqGrid({
            ...
            colModel:[{name:'id', index:'id', width:20,align:"center", sortable:false, formatter:function(value,rec,rowObject){
