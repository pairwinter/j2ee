...
(function(view){
    ...
    view.contact.group.initPage=function(groupsJson,context,isGroupLeader){
        /**
         zTree function
         */
        var group_permission = EB_Common.Security.protect("GROUP_add_edit_delete_view_list_removeContactFromGroup");
//        var edit_permission = EB_Common.Security.protect("GROUP_Edit_view_list_removeContactFromGroup");
        var settingFun = function(){
            return {
                ...
                edit: {
                    enable: group_permission,
                    showRemoveBtn:group_permission,
                    drag: {
                        isCopy: false,
                        isMove: group_permission
                    },
...
//        }
		...
		var treeObj = $.fn.zTree.init($("#grouptree"), settingFun(), rootNode);
//        treeObj.setEditable(edit_permission);
		var isNotLive = false;
...
//            var treeObj = $.fn.zTree.getZTreeObj(treeId);
            ...
            var url = "";
            if(treeNode.id>0){
                url = context+'/contacts/groups/tree/update/json';
            }else{
                url = context+'/contacts/groups/tree/insert/json';
            }
			$.ajax({
		        url:url,
		        data:{
...
//                                    .trigger("reloadGrid");
		...
		$("#addGroup").click(function(){
	        ...
	        var newNode = {id:'',name:i18n["contact.group.default.new"]};
		    if(nodes==null || nodes.length==0){
		        EB_Common.dialog.alert(i18n["contact.group.prompt1"]);
		        return false;
		    }else{
