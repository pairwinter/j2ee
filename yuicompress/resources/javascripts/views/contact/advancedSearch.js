...
(function(view){
    var advancedSearch = function(settings){
        ...
        this.addCondtion=function(field){
            ...
            var displayName = $('<input type="text"  name="displayName" readonly="readonly" class="input">').val(field[fieldReader.displayName]);
        ...
        this.init=function(settings){
            ...
            if(filterRules){
                $.each(filterRules,function(i,element){
                    var option = $('<option>').val(element.type).text(element[fieldReader.displayName]).attr('filterIndex',i);
            ...
            function search(){
                var isFilterVal = ($("input[name='isFilter']:checked").val()=="true")?true:false;
