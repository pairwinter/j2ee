(function(common){
    ...
    common.message.validation={
        ...
        phone_length_other :   "Please enter a valid phone number with digits, length is 4~20",
        jqueryValidate:	{
            required: i18n['global.validation.required'],
            remote: "Please fix this field.",
            email: i18n['global.validation.email'],
            ...
            equalTo: i18n['global.validation.conpassword'],
